...
for i in range(1, total_chapters + 1):
    url = f"https://valmikiramayan.net/utf8/yuddha/sarga{i}/yuddhasans{i}.htm"
    try:
...
# Save output to file
with open("valmiki_ramayan_yuddha_kanda_book6.txt", "w", encoding="utf-8") as f:
...
print("✅ Finished extracting all 128 chapters of Yuddha Kanda.")
